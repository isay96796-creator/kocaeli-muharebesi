...
class AssetManager {
    constructor() {
        this.assets = {};
        this.toLoad = [
            { name: 'background', src: 'background1.jpg' }, { name: 'player', src: 'player.png' },
            { name: 'player1', src: 'player1.png' }, { name: 'playerhappy1', src: 'playerhappy1.png' },
            { name: 'playerhappy2', src: 'playerhappy2.png' }, { name: 'vehicle', src: 'vehicle.png' },
            { name: 'activist', src: 'activist.png' }, { name: 'activist2', src: 'activist2.png' },
            { name: 'activist3', src: 'activist3.png' },
...
class Game {
    constructor() {
        ...
        document.getElementById('load-btn').onclick = () => { this.sm.playSFX('click'); this.loadGame(); document.getElementById('play-btn').click(); };
